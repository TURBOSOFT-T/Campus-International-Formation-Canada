                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            ...
                            <div data-i18n="Activités">Activités</div>
                        </a>
                        <ul class="menu-sub">
                            @can('category_view')
                                <li class="menu-item">
...
{{-- 
                    <li class="menu-item">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            ...
                            <div data-i18n="Offres">Offres</div>
                            <div class="badge bg-primary rounded-pill ms-auto"></div>
                        </a>
                        
                            <ul class="menu-sub">
                                <li class="menu-item">
                                    <a href="{{ route('offres') }}" class="menu-link">
                                        <div data-i18n="Liste ">Liste </div>
                                    </a>
                                </li>
                            </ul>
                            ...
                            <ul class="menu-sub">
                                <li class="menu-item">
                                    <a href="{{ route('offre.add') }}" class="menu-link">
                                        <div data-i18n=" Créer une offre"> Créer une offre</div>
                                    </a>
                                </li>
                            </ul>
                         ...
                         <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="{{ route('candidatures') }}" class="menu-link">
 ...
 --}}
                    ...
                    <li class="menu-item">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            ...
                            <div data-i18n="Partenaires">Partenaires</div>
                            <div class="badge bg-primary rounded-pill ms-auto"></div>
                        </a>
                        @can('sponsor_view')
                            <ul class="menu-sub">
                    ...
                    @can('image_view')
                        <li class="menu-item">
                            <a href="javascript:void(0);" class="menu-link menu-toggle">
                                <i class="menu-icon tf-icons ti ti-id"></i>
                                <div data-i18n="La gallerie">Gestion des galleries</div>
                                <div class="badge bg-primary rounded-pill ms-auto"></div>
                            </a>
                            <ul class="menu-sub">
                                <li class="menu-item">
                          ...
                          <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="{{ route('clients') }}" class="menu-link">
                                    <div data-i18n="Liste des clients">Liste de clients</div>
                                </a>
                            </li>
