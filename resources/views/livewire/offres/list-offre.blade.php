<div>
    ...
    <form wire:submit="filtrer">
        <div class="row">
            <div class="col-sm-6">
                <span>
                    <b>{{ $offres->count() }}</b> Résultats sur {{ $total }}.
                </span>
            </div>
            <div class="col-sm-6">
            ...
            <tbody>
                @forelse ($offres as $offre)
                    <tr>
                        ...
                        <td>
                            <img src="{{ Storage::url($offre->image) }}" width="40 " height="40 "
                                class="rounded shadow" alt="">
                        </td>
                        <td>
                            <button class="btn btn-sm btn-outline" data-bs-toggle="modal"
                                data-bs-target="#qr-code-{{ $offre->id }}">
                        ...
                        <td style="text-align: right;">
                            <div class="btn-group">
                               ...
                               {{--  <button class="btn btn-sm btn-dark"
                                    onclick="url(' {{ route('offres.update', ['id' => $offre->id]) }} ')">
                                    <i class="ri-edit-box-line"></i>
                                </button> --}}

                                <div class="col">
                                     
                                    <a  href="{{ route('offre.update',['id'=>$offre->id]) }}">
                                    ...
                                    <button class="btn btn-sm btn-danger"
                                        onclick="toggle_confirmation({{ $offre->id }})">
                            ...
                            <div class="modal fade" id="qr-code-{{ $offre->id }}" tabindex="-1" role="dialog"
                                aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h6 class="modal-title" id="myCenterModalLabel">
                                                Accès rapide au offre
                                            </h6>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="text-center p-2">
                                                {{-- {!! QrCode::size(100)->generate(route('offre2', ['id' => $offre->id])) !!} --}}
                                            </div>
                                        </div>
                                    </div><!-- /.modal-content -->
                                </div><!-- /.modal-dialog -->
                            ...
                            <button class="btn btn-sm btn-success d-none" type="button"
                                id="confirmBtn{{ $offre->id }}" wire:click="delete({{ $offre->id }})">
