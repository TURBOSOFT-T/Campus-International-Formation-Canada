                                ...
                                <div class="col-xxl-9 col-xl-9 col-lg-10">
                                    <div class="banner__content p-relative z-index-1">
                                        ...
                                        <h2 class="banner__title wow fade-in-bottom" data-wow-delay="400ms">
                                            {{ $banner->titre ?? '' }}</h2>
                                        <p style=" font-family: 'Times New Roman'; color:rgb(12, 239, 12);font-size: 22px; line-height: 2; text-align: justify;" class="h5 wow fade-in-bottom" data-wow-delay="400ms">
                                            {{ $banner->sous_titre ?? '' }}</p>
