...
@section('body')
    ...
    <main>
             ...
             <div class="breadcrumb__area breadcrumb-space overflow-hidden" style="background: url('{{ asset('storage/' .$config->imagecontact) }}')  center center / cover no-repeat;  height: 600px;">
                ...
                <div class="row align-items-center">
                    <div class="col-xl-5">
                        <div class="contact-us__widget mb-30 wow fadeInRight animated" data-wow-delay=".3s">
                            ...
                            {!! \App\Helpers\TranslationHelper::TranslateText( 'Vous pouvez également
                                nous contacter par téléphone ou par e-mail, il existe de nombreuses variantes') !!}
                            </p>
    ...
    padding: 16px; /* 1rem padding */
                    ...
                    <div class="col-xl-7">
                        <div class="contact-us__form-wrapper mb-30 mb-xs-25">
                            <h3 class="section__title mb-10 wow fadeInLeft animated" data-wow-delay=".3s">
                                {!! \App\Helpers\TranslationHelper::TranslateText( 'Envoyer un message') !!}
                            </h3>
                            <p class="mb-40 mb-sm-25 mb-xs-20 wow fadeInLeft animated" data-wow-delay=".5s">
                            {!! \App\Helpers\TranslationHelper::TranslateText( 'Vous pouvez
                                également nous contacter par téléphone ou par e-mail, il existe de nombreuses variantes') !!}
                            </p>
    ...
    <div class="container-fluid px-0">
        ...
        @else
           {{--  <p>
              ...
              <iframe
                                        src="https://maps.google.com/maps?q=168+Bd+Saint-Jean-Baptiste,+Châteauguay,+QC+J6K+3B5,+Canada+%26+Co.+KG&t=&z=13&ie=UTF8&iwloc=&output=embed"
