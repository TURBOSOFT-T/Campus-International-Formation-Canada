...
Route::get('/category_blog/{id}/{nom}', [HomeController::class, 'blogsByCategory'])->where('id', '[0-9]+');
...
////////////Offres/////////
Route::get('/nos_offres', [HomeController::class, 'offres'])->name('nos_offres');
Route::get('/category_offre/{id}/{nom}', [HomeController::class, 'offresByCategory'])->where('id', '[0-9]+');
Route::get('/details-offres/{id}/{slug}', [HomeController::class, 'details_offres'])->name('details-offres');
Route::get('searchoffre', [HomeController::class, 'searchoffre'])->name("searchoffre");
...
Route::get('/category_service/{id}/{nom}', [HomeController::class, 'servicesByCategory'])->where('id', '[0-9]+');
Route::get('searchformation', [HomeController::class, 'searchformation'])->name("searchformation");

Route::get('/btp_services', [HomeController::class, 'btp_services'])->name('btp_services');
Route::get('/tracking_services', [HomeController::class, 'tracking_services'])->name('tracking_services');
...
Route::get('/postuler', [CandidatureController::class, 'postuler'])->name('postulerr');
Route::post('/post', [CandidatureController::class, 'confirmPost'])->name('post.confirm');
Route::get('/thank-yous', [CandidatureController::class, 'index'])->name('thank-yous');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/admin/category/{id}', [AdminController::class, 'categories_update'])
...
Route::get('offre_update/{id}', [ AdminController::class, 'offres_update'])
->name('offre.update');

Route::get('/offre/add', [AdminController::class, 'offre_add'])
->name('offre.add');


    Route::get('/cadidatures', [AdminController::class, 'candidatures'])
            ->name('candidatures');
